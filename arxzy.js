...
module.exports = arxzy = async (arxzy, m, msg, chatUpdate, store) => {
    try {
        ...
        const isAdrian = ('6285786539008@s.whatsapp.net').includes(m.sender)
        /* ~~~~~~~~~ GROUP SYSTEM ~~~~~~~~~ */
...
item2.EMAIL;type=INTERNET:bot@fahrul.my.id\n
                    ...
                    arxzy.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://telegra.ph/file/734d7247c478a4f24e455.jpg',
                                sourceUrl: global.link,
                                mediaType: 1,
...
`.trim()
            ...
            case 'script':
            case 'scriptbot':
                uy = `https://youtube.com/shorts/O7JkNHCUF-0?si=PEl5GK-H-uut5fSD`
                arxzy.sendMessage(m.chat, {
                    text: uy,
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: 'Script Free',
                            body: `SCRIPT BOT ${namabot} chat owner untuk meminta`,
                            thumbnailUrl: 'https://telegra.ph/file/734d7247c478a4f24e455.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
